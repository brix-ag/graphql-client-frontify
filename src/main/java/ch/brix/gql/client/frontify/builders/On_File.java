...
public class On_File extends ch.brix.gql.client.TypeBuilder {
   ...
   */
  public On_File revisions(File_revisions callBuilder) {
    _add_call(callBuilder);
    return this;
  }
  /**
   ...
   */
  public On_File variants(File_variants callBuilder) {
    _add_call(callBuilder);
    return this;
  }
  /**
   ...
   */
  public On_File provenance(File_provenance callBuilder) {
    _add_call(callBuilder);
    return this;
  }
  /**
   ...
   */
  public On_File targets(File_targets callBuilder) {
    _add_call(callBuilder);
    return this;
  }
}
