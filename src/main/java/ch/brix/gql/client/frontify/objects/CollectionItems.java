...
public class CollectionItems {
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.Collection.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.Collection> items;
}
