...
@lombok.Data
public class AssetCommentReplyItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.AssetCommentReply.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.AssetCommentReply> items;
}
