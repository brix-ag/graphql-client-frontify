...
public class GuidelineItems {
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.Guideline.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.Guideline> items;
}
