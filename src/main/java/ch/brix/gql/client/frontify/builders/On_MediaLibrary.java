...
public class On_MediaLibrary extends ch.brix.gql.client.TypeBuilder {
   ...
   */
  public On_MediaLibrary assetsByExternalId(MediaLibrary_assetsByExternalId callBuilder) {
    _add_call(callBuilder);
    return this;
  }
  /**
   ...
   */
  public On_MediaLibrary searchAssets(MediaLibrary_searchAssets callBuilder) {
    _add_call(callBuilder);
    return this;
  }
  /**
