...
@lombok.Data
public class CatalogColumnItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.interfaces.CatalogColumn.class)
  private java.util.List<ch.brix.gql.client.frontify.interfaces.CatalogColumn> items;
}
