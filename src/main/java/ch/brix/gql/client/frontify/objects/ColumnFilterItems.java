...
@lombok.Data
public class ColumnFilterItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.ColumnFilterItem.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.ColumnFilterItem> items;
}
