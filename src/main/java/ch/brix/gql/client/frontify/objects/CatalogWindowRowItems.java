...
@lombok.Data
public class CatalogWindowRowItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.CatalogWindowRow.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.CatalogWindowRow> items;
}
