 ...
 */
@ch.brix.gql.client.PossibleTypes({ch.brix.gql.client.frontify.objects.CustomMetadataCatalogValue.class, ch.brix.gql.client.frontify.objects.CustomMetadataValue.class, ch.brix.gql.client.frontify.objects.CustomMetadataValues.class})
