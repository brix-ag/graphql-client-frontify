...
@lombok.Data
public class AssetRevisionItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.AssetRevision.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.AssetRevision> items;
}
