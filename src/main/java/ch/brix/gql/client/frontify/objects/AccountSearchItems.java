...
@lombok.Data
public class AccountSearchItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.unions.AccountSearchResult.class)
  private java.util.List<ch.brix.gql.client.frontify.unions.AccountSearchResult> items;
}
