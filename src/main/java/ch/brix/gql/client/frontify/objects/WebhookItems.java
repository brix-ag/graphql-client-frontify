...
public class WebhookItems {
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.interfaces.Webhook.class)
  private java.util.List<ch.brix.gql.client.frontify.interfaces.Webhook> items;
}
