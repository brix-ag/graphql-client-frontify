...
public class On_DocumentLibrary extends ch.brix.gql.client.TypeBuilder {
   ...
   */
  public On_DocumentLibrary assetsByExternalId(DocumentLibrary_assetsByExternalId callBuilder) {
    _add_call(callBuilder);
    return this;
  }
  /**
   ...
   */
  public On_DocumentLibrary searchAssets(DocumentLibrary_searchAssets callBuilder) {
    _add_call(callBuilder);
    return this;
  }
  /**
