...
@lombok.Data
public class GuidelineDocumentPageCategoryChildrenItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.unions.GuidelineDocumentPageCategoryChildNavigationItem.class)
  private java.util.List<ch.brix.gql.client.frontify.unions.GuidelineDocumentPageCategoryChildNavigationItem> items;
  /**
