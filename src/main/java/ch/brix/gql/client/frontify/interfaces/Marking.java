 ...
 */
@ch.brix.gql.client.PossibleTypes({ch.brix.gql.client.frontify.objects.MultiPageMarking.class, ch.brix.gql.client.frontify.objects.SimpleMarking.class, ch.brix.gql.client.frontify.objects.VideoMarking.class})
