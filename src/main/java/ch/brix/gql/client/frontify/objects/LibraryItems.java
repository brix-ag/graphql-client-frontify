...
public class LibraryItems {
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.interfaces.Library.class)
  private java.util.List<ch.brix.gql.client.frontify.interfaces.Library> items;
}
