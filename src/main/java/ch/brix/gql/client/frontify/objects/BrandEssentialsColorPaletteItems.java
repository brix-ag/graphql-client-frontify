...
@lombok.Data
public class BrandEssentialsColorPaletteItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.BrandEssentialsColorPalette.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.BrandEssentialsColorPalette> items;
}
