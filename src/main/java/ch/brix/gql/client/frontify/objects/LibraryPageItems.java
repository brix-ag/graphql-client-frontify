...
public class LibraryPageItems {
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.LibraryPage.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.LibraryPage> items;
}
