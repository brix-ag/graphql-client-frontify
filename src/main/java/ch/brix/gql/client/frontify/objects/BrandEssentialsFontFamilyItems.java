...
@lombok.Data
public class BrandEssentialsFontFamilyItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.BrandEssentialsFontFamily.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.BrandEssentialsFontFamily> items;
}
