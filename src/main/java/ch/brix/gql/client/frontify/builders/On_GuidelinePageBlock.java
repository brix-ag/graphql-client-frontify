...
public class On_GuidelinePageBlock extends ch.brix.gql.client.TypeBuilder {
   ...
   */
  public On_GuidelinePageBlock settings() {
    _add_field("settings");
    return this;
  }
  /**
   ...
   */
  public On_GuidelinePageBlock assetSettings(GuidelinePageBlock_assetSettings callBuilder) {
   ...
   */
  public On_GuidelinePageBlock type(GuidelinePageBlock_type callBuilder) {
    _add_call(callBuilder);
    return this;
  }
}
