...
public class On_Video extends ch.brix.gql.client.TypeBuilder {
   ...
   */
  public On_Video revisions(Video_revisions callBuilder) {
    _add_call(callBuilder);
    return this;
  }
  /**
   ...
   */
  public On_Video variants(Video_variants callBuilder) {
    _add_call(callBuilder);
    return this;
  }
  /**
   ...
   */
  public On_Video provenance(Video_provenance callBuilder) {
    _add_call(callBuilder);
    return this;
  }
  /**
   ...
   */
  public On_Video targets(Video_targets callBuilder) {
    _add_call(callBuilder);
    return this;
  }
}
