...
@lombok.Data
public class AssetCommentItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.AssetComment.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.AssetComment> items;
}
