...
public class SubFolderItems {
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.SubFolder.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.SubFolder> items;
}
