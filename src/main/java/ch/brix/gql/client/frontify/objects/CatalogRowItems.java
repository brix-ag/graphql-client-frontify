...
public class CatalogRowItems {
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.CatalogRow.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.CatalogRow> items;
}
