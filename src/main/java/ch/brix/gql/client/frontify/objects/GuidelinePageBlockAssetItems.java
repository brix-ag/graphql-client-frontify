...
@lombok.Data
public class GuidelinePageBlockAssetItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.GuidelinePageBlockAsset.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.GuidelinePageBlockAsset> items;
}
