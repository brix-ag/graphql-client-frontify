...
@lombok.Data
public class GuidelinePageItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.GuidelinePage.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.GuidelinePage> items;
}
