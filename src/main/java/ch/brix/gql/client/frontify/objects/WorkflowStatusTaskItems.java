...
@lombok.Data
public class WorkflowStatusTaskItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.WorkflowTask.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.WorkflowTask> items;
}
