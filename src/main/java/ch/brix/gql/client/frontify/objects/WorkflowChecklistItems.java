...
@lombok.Data
public class WorkflowChecklistItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.WorkflowChecklistItem.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.WorkflowChecklistItem> items;
}
