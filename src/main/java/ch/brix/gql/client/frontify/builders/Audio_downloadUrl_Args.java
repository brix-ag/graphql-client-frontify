...
public class Audio_downloadUrl_Args extends ch.brix.gql.client.ArgsBuilder {
  /**
   * Download `Url` validity in days. Defaults to `1` when both `validityInDays` and `permanent` arguments are not specified.
   * Default value: null
   */
  public Audio_downloadUrl_Args validityInDays(ch.brix.gql.client.frontify.scalars.IntScalar value) {
   ...
   * Default value: null
   */
  public Audio_downloadUrl_Args permanent(ch.brix.gql.client.frontify.scalars.BooleanScalar value) {
