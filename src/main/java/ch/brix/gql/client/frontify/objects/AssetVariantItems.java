...
@lombok.Data
public class AssetVariantItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.AssetVariant.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.AssetVariant> items;
}
