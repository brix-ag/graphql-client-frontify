...
public class FolderItems {
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.interfaces.Folder.class)
  private java.util.List<ch.brix.gql.client.frontify.interfaces.Folder> items;
}
