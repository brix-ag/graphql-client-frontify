...
@lombok.Data
public class Video implements ch.brix.gql.client.frontify.interfaces.Node, ch.brix.gql.client.frontify.interfaces.Asset {
  /**
   * `Asset` id.
   */
  ...
  private ch.brix.gql.client.frontify.scalars.FloatScalar duration;
  /**
   * `Video` bitrate in bits per second.
   */
  @com.google.gson.annotations.SerializedName("bitrate")
  private ch.brix.gql.client.frontify.scalars.IntScalar bitrate;
}
