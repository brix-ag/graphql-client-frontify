...
public class On_LogoLibrary extends ch.brix.gql.client.TypeBuilder {
   ...
   */
  public On_LogoLibrary assetsByExternalId(LogoLibrary_assetsByExternalId callBuilder) {
    _add_call(callBuilder);
    return this;
  }
  /**
   ...
   */
  public On_LogoLibrary searchAssets(LogoLibrary_searchAssets callBuilder) {
    _add_call(callBuilder);
    return this;
  }
  /**
