...
@lombok.Data
public class GuidelineDocumentGroupChildrenItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.unions.UnionGuidelineDocumentLibraryNavigationItemGuidelineDocumentLinkNavigationItemGuidelineDocumentNavigationItem.class)
  private java.util.List<ch.brix.gql.client.frontify.unions.UnionGuidelineDocumentLibraryNavigationItemGuidelineDocumentLinkNavigationItemGuidelineDocumentNavigationItem> items;
  /**
