...
@lombok.Data
public class GuidelinePageBlockAssetSettingItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.GuidelinePageBlockAssetSetting.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.GuidelinePageBlockAssetSetting> items;
}
