...
public class CatalogItems {
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.Catalog.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.Catalog> items;
}
