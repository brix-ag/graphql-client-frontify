...
@lombok.Data
public class LibraryPageCollectionItems {
  /**
  ...
  /**
   * **BETA** List of `LibraryPage` `Collection` items.
   */
  @com.google.gson.annotations.SerializedName("items")
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.LibraryPageCollection.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.LibraryPageCollection> items;
}
