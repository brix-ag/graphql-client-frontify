...
@lombok.Data
public class GuidelineDocumentChildrenItems {
  /**
   * **BETA** The paginated list of `GuidelineDocument` children navigation items.
   */
  @com.google.gson.annotations.SerializedName("items")
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.unions.GuidelineDocumentChildNavigationItem.class)
  private java.util.List<ch.brix.gql.client.frontify.unions.GuidelineDocumentChildNavigationItem> items;
  /**
