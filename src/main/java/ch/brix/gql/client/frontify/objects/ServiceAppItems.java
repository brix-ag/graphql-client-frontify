...
@lombok.Data
public class ServiceAppItems {
  /**
   * **BETA** `ServiceApp` items.
   */
  @com.google.gson.annotations.SerializedName("items")
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.ServiceApp.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.ServiceApp> items;
  /**
