...
@lombok.Data
public class BrandEssentialsColorItems {
  /**
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.BrandEssentialsColor.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.BrandEssentialsColor> items;
}
