...
public class UserGroupItems {
  ...
  @ch.brix.gql.client.InnerType(ch.brix.gql.client.frontify.objects.UserGroup.class)
  private java.util.List<ch.brix.gql.client.frontify.objects.UserGroup> items;
}
