...
@lombok.Data
public class CatalogLinkColumn implements ch.brix.gql.client.frontify.interfaces.CatalogColumn {
  /**
   ...
   */
  @com.google.gson.annotations.SerializedName("targetCatalog")
  private ch.brix.gql.client.frontify.objects.Catalog targetCatalog;
}
